...
(defmethod update-instance-for-different-class :after ((previous-instance persistent-object)
  ...
  (bind ((previous-class (class-of previous-instance))
    ...
    (setf (class-name-of current-instance) (name-of current-class))
