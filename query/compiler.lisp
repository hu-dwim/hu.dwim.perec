...
(defun parse-query (query)
  (setf (asserts-of query) (mapcar #L(parse-query-form !1 query) (asserts-of query)))
  (setf (action-args-of query) (mapcar #L(parse-query-form !1 query) (action-args-of query)))
  (setf (order-by-of query) (iter (for (dir expr) on (order-by-of query) by 'cddr)
                                  (nconcing (list dir (parse-query-form expr query))))))
