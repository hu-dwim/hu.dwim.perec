...
(deftest test/persistence/cache/without-caching-slot-values ()
...
(deftest test/persistence/cache/slot/multiple-read ()
  (bind ((object
          (with-transaction
...
(deftest test/persistence/cache/slot/write-and-read ()
  (with-transaction
...
(deftest test/persistence/cache/reference/multiple-read ()
  (bind ((object
          (with-transaction
...
(deftest test/persistence/cache/association/1-1/read-initial-value ()
  (with-transaction
...
(deftest test/persistence/cache/association/1-1/multiple-read ()
  (bind (((sister brother)
          (with-transaction
            (bind ((sister (make-instance 'sister-test))
                   (brother (make-instance 'brother-test :sister sister)))
...
(deftest test/persistence/cache/association/1-1/write-and-read ()
...
(deftest test/persistence/cache/association/1-n/multiple-read ()
  (bind ((child
          (with-transaction
...
(deftest test/persistence/cache/association/1-n/write-and-read ()
