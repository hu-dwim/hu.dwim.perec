...
(def-type-test date/1 date (let ((*default-timezone* +utc-zone+)) (parse-timestring "2006-06-06")))

(def-type-test time/1 time (let ((*default-timezone* +utc-zone+)) (parse-timestring "06:06:06")))
